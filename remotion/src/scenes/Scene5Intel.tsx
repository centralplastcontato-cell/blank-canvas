    ...
    <AbsoluteFill>
      ...
      <AbsoluteFill style={{ padding: "0 55px", display: "flex", flexDirection: "column" }}>
        <div style={{ marginTop: 260 }}>
          <p style={{
            fontFamily, fontWeight: 700, fontSize: 22, color: "#22d3ee",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, marginTop: 55 }}>
          <div style={{
            ...
            border: "1px solid rgba(255,255,255,0.06)", padding: "30px 28px",
          }}>
            <p style={{ fontFamily, fontWeight: 800, fontSize: 28, color: "white", margin: "0 0 24px 0" }}>📈 Funil de Vendas</p>
            {[
              ...
              return (
                <div key={i} style={{ marginBottom: 18 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                    <span style={{ fontFamily, fontWeight: 600, fontSize: 22, color: "rgba(255,255,255,0.6)" }}>{step.label}</span>
                    <span style={{ fontFamily, fontWeight: 800, fontSize: 22, color: step.color }}>{step.value}</span>
                  </div>
                  <div style={{ height: 12, borderRadius: 6, background: "rgba(255,255,255,0.05)" }}>
                    <div style={{ height: 12, borderRadius: 6, width: `${barWidth}%`, background: step.color }} />
                  </div>
                </div>
              );
            })}
          ...
          <div style={{
            ...
            <p style={{ fontFamily, fontWeight: 800, fontSize: 28, color: "white", margin: "0 0 12px 0" }}>⚡ Tempo Médio de Resposta</p>
            <p style={{ fontFamily, fontWeight: 900, fontSize: 72, color: "#22d3ee", margin: "0 0 8px 0" }}>3 min</p>
            <p style={{ fontFamily, fontWeight: 400, fontSize: 20, color: "rgba(255,255,255,0.3)", margin: 0 }}>Alertas automáticos para leads sem resposta</p>
          </div>
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
