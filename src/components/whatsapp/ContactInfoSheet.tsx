                    ...
                    <div className="rounded-2xl border border-border/60 bg-card shadow-sm overflow-hidden">
                      <div className="px-4 py-3 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-sm font-semibold text-foreground">Formulário de dados</p>
                      ...
                      <div className="px-4 py-2.5 border-t border-border/40">
                        <p className="text-[11px] text-muted-foreground truncate font-mono">{clientDataLink}</p>
                      </div>
