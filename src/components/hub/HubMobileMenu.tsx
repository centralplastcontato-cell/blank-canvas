...
interface HubMobileMenuProps {
  ...
  currentPage: "hub" | "empresas" | "users" | "whatsapp" | "onboarding" | "prospeccao" | "comercial-b2b" | "consumo-ia" | "treinamento" | "leads" | "suporte" | "materiais" | "recrutamento" | "funcionalidades";
  userName: string;
  userEmail: string;
...
const menuItems = [
  ...
  { id: "funcionalidades", label: "Funcionalidades", icon: BookOpen, path: "/hub/funcionalidades" },
