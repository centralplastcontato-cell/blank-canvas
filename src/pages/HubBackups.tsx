      ...
      <div className="space-y-6 p-4 md:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Backup automático semanal + download manual de todos os dados críticos</p>
          </div>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-xs mt-1">Clique em "Gerar Backup Agora" ou aguarde o backup automático de domingo.</p>
              </div>
            ) : (
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm space-y-1">
                ...
                <p className="text-muted-foreground">Todo <strong>domingo à noite</strong>, o sistema gera automaticamente um backup completo de leads, eventos, despesas e contatos de todas as empresas. Os arquivos ficam disponíveis para download por tempo ilimitado.</p>
                <p className="text-muted-foreground">Além disso, o Supabase realiza backups diários automáticos do banco com retenção de 7 dias.</p>
              </div>
            </div>
          </CardContent>
        </Card>
