              ...
              <div className="hidden md:block">
                <div className="relative rounded-2xl border border-border/30 bg-gradient-to-r from-card via-card to-primary/[0.03] shadow-[0_4px_24px_rgba(0,0,0,0.04)] overflow-hidden">
                  ...
                  <div className="relative flex items-center gap-4 p-5 md:p-6">
                    ...
                    <div>
                      <h1 className="text-2xl lg:text-3xl font-extrabold tracking-tight text-foreground">Gestão de Usuários</h1>
                      <p className="text-sm text-muted-foreground/70 mt-0.5">Gerencie usuários, permissões e acessos do sistema</p>
                    </div>
                  </div>
                </div>
              </div>
